...
$DB_CMD "CREATE TABLE mantis_project_table(id)" $DB_CMD_SCHEMA
$DB_CMD "CREATE TABLE mantis_project_version_table(id)" $DB_CMD_SCHEMA
$DB_CMD "CREATE TABLE mantis_tag_table(id)" $DB_CMD_SCHEMA
echo TABLES CREATED
